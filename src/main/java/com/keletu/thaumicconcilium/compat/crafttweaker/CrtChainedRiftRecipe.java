package com.keletu.thaumicconcilium.compat.crafttweaker;
...
public class CrtChainedRiftRecipe {
    ...
    public static class Add implements IAction {
        ...
        @Override
        public void apply() {
            ChainedRiftRecipe.addRiftRecipe(new ResourceLocation(ThaumicConcilium.MODID, id), ChainedRiftRecipe.addChainedRiftRecipe(researchKey, result, catalyst, list));
        }
