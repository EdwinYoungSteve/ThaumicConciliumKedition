...
import static com.keletu.thaumicconcilium.client.render.RenderProjectileEtherealShackles.*;
import com.keletu.thaumicconcilium.client.render.ShaderHelper;
...
public class ModelEvents {
    ...
    public static void regModels(ModelRegistryEvent event) {
        defaultModel(TCItems.pontifex_hood);
        defaultModel(TCItems.pontifex_robe);
        defaultModel(TCItems.pontifex_legs);
        ...
        defaultModel(TCItems.research_page);
        defaultModel(TCItems.research_page, 1);
        defaultModel(TCItems.research_page, 2);
        defaultModel(TCItems.research_page, 3);
        ...
        defaultModel(TCItems.item_icon, 2);

        defaultModel(TCItems.quicksilverCrucible);
        defaultModel(TCItems.destabilizedCrystal);
        defaultModel(TCItems.visCondenser);
        defaultModel(TCItems.hexOfPredictor);
    }
