package com.keletu.thaumicconcilium.proxy;
...
public class ClientProxy extends CommonProxy {
    ...
    public void regRenderer() {
        RenderingRegistry.registerEntityRenderingHandler(EntityVengefulGolem.class, new RenderVengefulGolem(new ModelVengefulGolem(), new ResourceLocation(ThaumicConcilium.MODID + ":textures/models/entity/vengeful_golem.png"), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler(EntityDissolved.class, new RenderDissolved(new ModelBiped(), new ResourceLocation(ThaumicConcilium.MODID + ":textures/models/entity/thaumaturge.png"), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler(EntityUpcomingHole.class, new RenderUpcomingHole());
        RenderingRegistry.registerEntityRenderingHandler(EntityQuicksilverElemental.class, new RenderQuicksilverElemental(new ModelBiped(), new ResourceLocation(ThaumicConcilium.MODID + ":textures/models/entity/quicksilver_elemental.png"), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler(EntityOveranimated.class, new RenderThaumaturge(new ModelBiped(), new ResourceLocation(ThaumicConcilium.MODID + ":textures/models/entity/overanimated.png"), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler(EntityThaumGib.class, new RenderThaumGib());
        RenderingRegistry.registerEntityRenderingHandler(EntityThaumaturge.class, new RenderThaumaturge(new ModelBiped(), new ResourceLocation(ThaumicConcilium.MODID + ":textures/models/entity/thaumaturge.png"), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler(EntityStrayedMirror.class, new RenderStrayedMirror(new ModelBiped(), new ResourceLocation(ThaumicConcilium.MODID + ":textures/models/entity/thaumaturge.png"), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler(EntitySamurai.class, new RenderSamurai(new ModelBiped(), new ResourceLocation(ThaumicConcilium.MODID + ":textures/models/entity/thaumaturge.png"), 0.15f));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCrimsonPaladin.class, new RenderCrimsonPaladin(new ModelBiped(), new ResourceLocation(ThaumicConcilium.MODID + ":textures/models/entity/crimson_paladin.png"), 0.5f));
        RenderingRegistry.registerEntityRenderingHandler(EntityEtherealShackles.class, new RenderProjectileEtherealShackles());
        RenderingRegistry.registerEntityRenderingHandler(EntityMadThaumaturge.class, new RenderThaumaturge(new ModelBiped(), new ResourceLocation(ThaumicConcilium.MODID + ":textures/models/entity/mad_thaumaturge.png"), 0.5f));
