    ...
    public void onUpdate() {
        ...
        if (!this.world.isRemote) {
            if (ticksExisted >= 30) {
                ...
                ThaumicConcilium.packetInstance.sendToAllAround(new PacketMakeHole(posX, posY, posZ), new NetworkRegistry.TargetPoint(world.provider.getDimension(), posX, posY, posZ, 32.0F));
                this.setDead();
            }
        } else {
