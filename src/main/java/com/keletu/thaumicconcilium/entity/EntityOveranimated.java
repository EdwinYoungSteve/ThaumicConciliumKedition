...
import com.keletu.thaumicconcilium.packet.PacketFXBloodsplosion;
...
public class EntityOveranimated extends EntityMob {
    ...
    protected void onDeathUpdate() {
        if (!this.world.isRemote) {
            ...
            ThaumicConcilium.packetInstance.sendToAllAround(new PacketFXBloodsplosion(posX, posY, posZ), new NetworkRegistry.TargetPoint(world.provider.getDimension(), posX, posY, posZ, 32.0));
        }
        this.setDead();
    }
    ...
    protected SoundEvent getAmbientSound() {
        return new SoundEvent(new ResourceLocation(ThaumicConcilium.MODID + ":gargle_many"));
    }
