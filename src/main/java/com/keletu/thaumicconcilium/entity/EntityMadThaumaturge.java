...
public class EntityMadThaumaturge extends EntityMob {
    ...
    protected SoundEvent getAmbientSound() {
        return new SoundEvent(new ResourceLocation(ThaumicConcilium.MODID + ":sad"));
    }
    ...
    protected void dropFewItems(boolean flag, int i) {
        ...
        if (d > 7) {
            ...
            if (r <= 3) {
                EntityUtils.entityDropSpecialItem(this, new ItemStack(TCItems.research_page, 1, 3), height / 2.0f);
            } else if (r <= 5) {
                EntityUtils.entityDropSpecialItem(this, new ItemStack(TCItems.research_page, 1, 4), height / 2.0f);
            } else if (r <= 7) {
                EntityUtils.entityDropSpecialItem(this, new ItemStack(TCItems.research_page, 1, 0), height / 2.0f);
            } else {
                EntityUtils.entityDropSpecialItem(this, new ItemStack(TCItems.research_page, 1, 6), height / 2.0f);
            }
        } else {
