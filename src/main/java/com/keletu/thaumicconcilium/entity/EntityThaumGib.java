...
public class EntityThaumGib extends EntityMob {
    ...
    protected SoundEvent getAmbientSound() {
        return new SoundEvent(new ResourceLocation(ThaumicConcilium.MODID + ":gargle_one"));
    }
    ...
    protected SoundEvent getDeathSound() {
        return new SoundEvent(new ResourceLocation(ThaumicConcilium.MODID + ":gargle_pain"));
    }
