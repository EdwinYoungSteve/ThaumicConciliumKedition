...
import com.keletu.thaumicconcilium.events.EventHandlerEntity;
...
public class CapThaumicConcilium implements ICapConcilium {
    public static final ResourceLocation CHAINED_TIME = new ResourceLocation(ThaumicConcilium.MODID, "chained_time");
    public static final ResourceLocation ETHEREAL = new ResourceLocation(ThaumicConcilium.MODID, "ethereal");
    public static final ResourceLocation PONTIFEX_TOGGLE = new ResourceLocation(ThaumicConcilium.MODID, "pontifex_toggle");
