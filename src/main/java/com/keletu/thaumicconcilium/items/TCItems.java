...
public class TCItems {
    ...
    public static final Item blustering_ring = new ItemRingOfBlusteringLight().setRegistryName("ring_of_blustering_light").setTranslationKey("ring_of_blustering_light").setCreativeTab(ThaumicConcilium.tabThaumicConcilium);
    public static final Item crimson_dagger = new ItemCrimsonDagger().setRegistryName("crimson_dagger").setTranslationKey("crimson_dagger").setCreativeTab(ThaumicConcilium.tabThaumicConcilium);
