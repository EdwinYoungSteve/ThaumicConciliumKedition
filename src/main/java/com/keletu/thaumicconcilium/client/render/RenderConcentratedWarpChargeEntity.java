...
import com.keletu.thaumicconcilium.client.model.ModelConcentratedWarpCharge;
import com.keletu.thaumicconcilium.entity.EntityConcentratedWarpCharge;
...
public class RenderConcentratedWarpChargeEntity extends Render {
    ...
    private static final ResourceLocation rl = new ResourceLocation(ThaumicConcilium.MODID + ":textures/models/entity/warp_cube.png");
