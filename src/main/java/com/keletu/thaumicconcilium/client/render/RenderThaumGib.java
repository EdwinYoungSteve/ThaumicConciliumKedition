...
import com.keletu.thaumicconcilium.client.model.ModelGibbedBiped;
...
public class RenderThaumGib extends Render {
    ...
    ResourceLocation texture = new ResourceLocation(ThaumicConcilium.MODID + ":textures/models/entity/thaumaturge.png");
