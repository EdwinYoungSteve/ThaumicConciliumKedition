...
import com.keletu.thaumicconcilium.client.model.FakeModelFortressArmor;
import com.keletu.thaumicconcilium.client.model.FakeModelVoidFortressArmor;
import com.keletu.thaumicconcilium.client.render.layer.LayerGolemBell;
import com.keletu.thaumicconcilium.entity.EntitySamurai;
...
public class RenderSamurai extends RenderBiped {
    ...
    private final ResourceLocation shadowFortress = new ResourceLocation(ThaumicConcilium.MODID, "textures/models/armor/shadow_fortress_armor.png");
    ...
    private static ResourceLocation diceTexture = new ResourceLocation(ThaumicConcilium.MODID, "textures/models/dice/1221.png");
    ...
    protected void renderModel(EntityLivingBase entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        ...
        if (diceModel == null) {
            diceModel = AdvancedModelLoader.loadModel(new ResourceLocation(ThaumicConcilium.MODID, "textures/models/dice/dice12.obj"));
        }
