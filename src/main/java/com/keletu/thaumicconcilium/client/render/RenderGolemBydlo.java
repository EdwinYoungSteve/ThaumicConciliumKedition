...
import com.keletu.thaumicconcilium.entity.EntityGolemBydlo;
...
public class RenderGolemBydlo extends RenderLiving {
    ModelBase damage;
    private static final ResourceLocation thaumium = new ResourceLocation(ThaumicConcilium.MODID, "textures/models/entity/golem_bydlo.png");
