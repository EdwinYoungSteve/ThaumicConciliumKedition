package com.keletu.thaumicconcilium.client.model;
...
public class ModelVengefulGolem extends ModelBiped {
    ...
    public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
        ...
        GL11.glPushMatrix();
        Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(ThaumicConcilium.MODID, "textures/models/golem_brain.png"));
        GL11.glScalef(1.3F / f6, 1.5F / f6, 1.3F / f6);
